...
- ~~**Rich text**~~ (REQ-220) — **built 2026-07-31** (WIN-90, ARCH-100): the dialect parses in `client/core/richtext.c` and Win32 renders it as DirectWrite ranges, delimiters removed in the transcript and faint in the composer. What is left of this row is the **formatting toolbar and Ctrl+B/Ctrl+I** (WIN-96) — a second way to author what you can now already type — and it no longer blocks snippets (REQ-226). **P2**
