 ...
 * S3/MinIO (SigV4) implementation drops in behind the same functions later.
 *
...
/* Open the store rooted at `base_dir` (created if absent). Returns NULL on
 * failure. */
