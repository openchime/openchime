...
| [VIDEO.md](docs/VIDEO.md) | Screen sharing in calls: the codec as a wire contract, fragments, NACKs and keyframe requests inside the encryption, rate control, and the Windows surfaces. |
